...
struct Node {
    ...
    //Adds a link between the current node and the node n, link being a read and/or write of the argument arg
...
//Generate all of the graphs object for a file, (generate one for each function)
