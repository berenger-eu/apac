...
class ASTInitVisitorVisitor : public RecursiveASTVisitor<ASTInitVisitorVisitor>
{
public:
	ASTInitVisitorVisitor(Rewriter &R) : TheRewriter(R) {}
...
private:
	ASTInitVisitorVisitor VisitorInit;
