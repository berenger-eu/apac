...
int linkable_apacSeq(int N1, int N2) {
    int i;
...
void cc_core_apacSeq(int i, int cc)
{
   int j, n;
...
;
void cc_core_seq_apacSeq(int i, int cc)
{
   int j, n;
